...
def test_image_collection_indexer_sampling(collection):
    print("Testing ImageCollectionIndexer sampling...")
    ...
    # Test pids sampling
    print("\nTesting _sample_pids...")
    sampled_pids = indexer._sample_pids()
    print(f"  Sampled {len(sampled_pids)} image indices")
    print(f"  Sample PIDs: {list(sampled_pids)[:5]}...")
    
    # Test embedding sampling
    print("\nTesting _sample_embeddings...")
    avg_doclen = indexer._sample_embeddings(sampled_pids)
    print(f"  Average doclen: {avg_doclen}")
    print(f"  Expected: 1.0 (for images)")
